...
if (btn_articulo.dataset.active=="true"){
    ...
    Array.prototype.forEach.call(option_articulo, function (articulo) {
        ...
        name_articulo.innerHTML = `
                    ...
                    `;
        name_articulo.className  = "selectedrop"; "";
        ...
        let dataTipoProd = {};
            ...
            btn_marca.style.backgroundImage = "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAJCAQAAAChr3WYAAAASUlEQVR4AV3BAQkAIRBFwQ9mMIQmMYqRjLJFLGEG4R2LJ+c5I4ybiczkNMmSaJyaHJHBNohaqGxVG4GO6wR9KLiiPwzTjUTS6wG6SmNlT4Eq4QAAAABJRU5ErkJggg==')";
            ...
            btn_producto.style.color = "#34343480";
            btn_producto.style.border = "1px solid #34343480";
...
if (btn_marca.dataset.active=="true"){
    ...
    Array.prototype.forEach.call(option_marca, function (marca) {
        ...
        name_marca.className  = "selectedrop"; "";
        ...
        productosUnicos = dataArticuloFiltro.filter(
            ...
            btn_producto.style.backgroundImage = "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAJCAQAAAChr3WYAAAASUlEQVR4AV3BAQkAIRBFwQ9mMIQmMYqRjLJFLGEG4R2LJ+c5I4ybiczkNMmSaJyaHJHBNohaqGxVG4GO6wR9KLiiPwzTjUTS6wG6SmNlT4Eq4QAAAABJRU5ErkJggg==')";
...
if (btn_producto.dataset.active=="true"){
    ...
    Array.prototype.forEach.call(option_producto, function (producto) {
        ...
        name_producto.innerHTML = `
                    ...
                    `;
        name_producto.className  = "selectedrop"; "";
...
aplicarArticulo.addEventListener("click", (e)=>{
    ...
    if (aplicarArticulo.dataset.active=="true"){
        ...
        let template = `<div id="resultado-cont${contadorTotalProductos}" style="border-bottom: 1px solid rgb(112, 112, 112); padding: 20px 0;">
                ...
                <div class="botones">
                    <div style="margin-bottom: 15px; display: inline-flex; justify-content: space-around;align-items: baseline;width: 164px;padding:20px 0;border: 1px solid #343434;border-radius: 6px;text-align: center;font: normal normal 500 16px/19px Roboto;letter-spacing: 0px;color: #FFFFFF;opacity: 1; background: #000000;">
                    ...
                    <input class="verDetalles" type="button" value="Ver detalles" data-marca="${resultados[0].marca.trim()}" data-mod="${resultados[0].producto}" data-descrip="${resultados[0].descripcion}"
                        style="cursor:pointer; width: 188px;padding:20px 0;border: 1px solid #207fe6;border-radius: 6px;text-align: center;font: normal normal 500 16px/19px Roboto;letter-spacing: 0px;color: #FFFFFF;opacity: 1; background: #207fe6;">
...
function limpiaSelects(){
   titMar.style.color = "#34343480"; 
    ...
    btn_marca.style.border = "1px solid #34343480";
    titMod.style.color = "#34343480"; 
    ...
    btn_marca.style.backgroundImage = "url('data:image/png;base64,')";
    
    btn_producto.innerHTML = ` <p id="nameProd" style="margin:0; pointer-events: none;">Modelo <span id="countModelo">(-)</span></p>`;
    btn_producto.style.cursor = "no-drop";
    btn_producto.style.backgroundImage = "url('data:image/png;base64,')";

    aplicarArticulo.style.background = "transparent";
    aplicarArticulo.style.cursor = "no-drop";
    name_articulo.innerHTML = ` Articulos <span id="contArt">(${categoriasUnicas.length})</span>`;
    name_articulo.className = "";
}
